...
Use this checklist after deterministic tools pass and before delivering generated or modified RTL. Final delivery requires `scripts/verilog_generated_deliverable_gate.py` to report zero errors and zero strict warnings.
