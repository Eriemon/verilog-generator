...
# 行尾注释抽取与严重级别计算单独成组，方便 header 规则阅读。
from .quality_gate_common import (
    _line_comment,
    _line_comment_start,
    _style_severity,
