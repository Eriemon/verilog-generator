...
PATH_SKILL_ROOT = Path(__file__).resolve().parents[1]  # 当前 skill 主体目录，用于直运行时定位 runtime 包
...
def read_skill_dependency_settings(settings: dict[str, Any]) -> dict[str, Any]:
    ...
    from runtime.verilog_generator.config import skill_dependency_settings  # pylint: disable=import-outside-toplevel
...
def read_settings_file(path_settings: Path) -> dict[str, Any]:
    ...
    from runtime.verilog_generator.config import load_settings  # pylint: disable=import-outside-toplevel
...
def read_fpga_developer_routing_settings(settings: dict[str, Any]) -> dict[str, Any]:
    ...
    from runtime.verilog_generator.config import fpga_developer_routing_settings  # pylint: disable=import-outside-toplevel
